        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserCreateId = table.Column<int>(type: "integer", nullable: false),
                    UserDoId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    IdTask1 = table.Column<int>(type: "integer", nullable: false),
                    IdTask2 = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskRelations_Tasks_IdTask1",
                        column: x => x.IdTask1,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskRelations_Tasks_IdTask2",
                        column: x => x.IdTask2,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskRelations_IdTask1",
                table: "TaskRelations",
                column: "IdTask1");

            migrationBuilder.CreateIndex(
                name: "IX_TaskRelations_IdTask2",
                table: "TaskRelations",
                column: "IdTask2");
